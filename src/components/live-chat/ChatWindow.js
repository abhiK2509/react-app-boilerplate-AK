...
const ChatWindow = () => {
    ...
    const data = [
      {
        ...
        photo:
          "https://yt4.ggpht.com/vmeLkGr5P2NQpFNIguT2r6SSaairXbQ3neOx11unJYFocpFkoGJEnjEicih_LFomh38hOX9Smg=s32-c-k-c0x00ffffff-no-rj",
        message:
  ...
  return (
    <div className="flex w-full h-[500px] border border-black m-5 overflow-y-scroll flex-col-reverse">
